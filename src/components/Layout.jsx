...
const Layout = ({ children }) => {
  ...
  const menuItems = [
    ...
    { path: '/dealer-management/create-dealer-profile', label: 'Add Dealer', icon: '➕', roles: ADMIN_ROLES },
    { path: '/dealer-management/list-dealers', label: 'List Dealers', icon: '🏪', roles: ADMIN_ROLES },
