...
const productionManagerRoutes = require('./server/routes/productionManager');
...
app.use('/api/manufacturing', conditionalAuth, requireRole('Administrator', 'Manager', 'Management Authority', 'Production Manager'), manufacturingRoutes);
app.use('/api/production-manager', conditionalAuth, requireRole('Production Manager'), productionManagerRoutes);
