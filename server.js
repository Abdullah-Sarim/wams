...
app.use('/api/billing-payment', conditionalAuth, billingPaymentRoutes);
...
app.use('/api/reporting', conditionalAuth, reportingRoutes);
app.use('/api/system-maintenance', conditionalAuth, systemMaintenanceRoutes);
